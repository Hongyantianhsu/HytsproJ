...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
    ...
    private static void addSaveInfo(Schema schema) {
        ...
        entity.addStringProperty("savePath").notNull();
        // 与在 Java 中使用驼峰命名法不同，默认数据库中的命名是使用大写和下划线来分割单词的。
        // For example, a property called “creationDate” will become a database column “CREATION_DATE”.
        entity.addLongProperty("countLength").notNull();
        entity.addLongProperty("readLength").notNull();
        entity.addIntProperty("stateInte").notNull();

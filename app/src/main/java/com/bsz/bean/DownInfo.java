...
import com.bsz.rx_retrofit.DownState;
import com.bsz.rx_retrofit.listener.HttpDownOnNextListener;
...
public class DownInfo {
    ...
    /*下载唯一的HttpService*/
    @Transient
    private HttpUtil.HttpService service;
    /*回调监听*/
    @Transient
    ...
    public HttpUtil.HttpService getService() {
        return service;
    }

    public void setService(HttpUtil.HttpService service) {

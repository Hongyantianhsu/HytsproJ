...
public class Contants {
    ...
    // 设置个人资料
    public static final String SET_PERSONAL_INFO_URI = HOST + "" +
            "Personal/setPersonalInfo";
    // 更新用户头像
    public static final String SET_PERSONAL_HEAD_URI = HOST + "" +
            "Personal/setPersonalheadimg";
    // 我要吐槽
    public static final String SPEEK_URI = HOST + "" +
            "Personal/sysPullAway";
    // 获取用户头像
    public static final String GET_PERSONAL_HEAD_URI = HOST + "" +
            "Personal/getPersonalheadimg";
    // 积分管理_等级
    ...
    // 我关注的list
    public static final String ATTEN_ME_LIST_URI = HOST + "" +
            "Personal/attenMeList";
    // 我的话题
    public static final String MY_TOPIC_URI = HOST + "" +
            "Personal/myTalk";
    // 塔罗师主页面
    ...
    // 签到领心币
    public static final String SIGN_LOGIN_URI = HOST + "" +
            "Personal/signLogin";
    // 查看签到领心币
    public static final String GET_SIGN_LOGIN_URI = HOST + "" +
            "Personal/getSignLogin";
    // 查看签到状态
    public static final String CHECK_SIGN_URI = HOST + "" +
            "Personal/checkSign";
    // 查看签到列表
    public static final String GET_SIGN_LIST_URI = HOST + "" +
            "Personal/getSignList";
    // 获得塔罗师个人标签
    public static final String GET_TAROT_LABEL_URI = HOST + "HomePage/getTarotLabel";
    // 关注和取消关注
    public static final String ATTEN_PEOPLE_URI = HOST + "" +
            "Personal/attenPeple";
    // 获取系统标签
    public static final String GET_SYSTEM_LABEL_URI = HOST + "HomePage/getSystemLabel";
    // 添加个人标签
    public static final String ADD_LABEL_URI = HOST + "" +
            "Personal/addLabel";
    // 新版塔罗大厅列表
    ...
    // 我的订单列表
    public static final String MY_ORDER_URI = HOST + "" +
            "Personal/newOrderList";
    // 我的订单详情
    public static final String ORDER_INFO_URI = HOST + "" +
            "Personal/newOrderInfo";
    //塔罗师确认接单详情
    public static final String TAROT_ACCEPT_ORDER = HOST + "" +
            "Personal/tarotComfirmInfo";
    // 立即咨询建立
    ...
    // 交易管理
    public static final String TRADE_MANAGER_URI = HOST + "" +
            "Personal/tradeManger";
    // 绑定支付宝
    public static final String BIND_ALPAY_URI = HOST + "" +
            "Personal/bindALPay";
    // 获取支付宝
    public static final String GET_ALPAY_URI = HOST + "" +
            "Personal/getAlpay";
    // 积分充值管理(产生订单)
    ...
    // 评价咨询
    public static final String JUDGE_CONSULT_URI = HOST + "" +
            "Personal/judgeConsult";
    // 我的优惠券
    ...
    // 评价详情
    public static final String FEEDBACK_INFO_URI = HOST + "" +
            "Personal/feedbackInfo";
    // 塔罗师回评提交
    public static final String TAROT_FEEDBACK_SAVE_URI = HOST + "" +
            "Personal/tarotFeedbackSave";
    // 首页服务分类列表
    public static final String SERVER_URI = HOST + "Index/server";
    // 获取账户余额
    public static final String GET_BALANCE_URI = HOST + "" +
            "Personal/getBalance";
    // 绑定支付宝
    public static final String BIND_ALIPAY_URI = HOST + "" +
            "Personal/bindAlipay";
    // 判断是否绑定支付宝
    public static final String IS_BIND_ALIPAY_URI = HOST + "" +
            "Personal/isBindAlipay";
    // 提现申请
    public static final String WITHDRAW_URI = HOST + "" +
            "Personal/withdraw";
    // 解绑支付宝
    public static final String UN_BIND_ALIPAY_URI = HOST + "" +
            "Personal/unBindAlipay";
    // 账户明细
    public static final String ACCOUNT_DETAILS_URI = HOST + "" +
            "Personal/accountDetails";
    // 提现文案
    public static final String WITH_DRAW_TEXT_URI = HOST + "" +
            "Personal/withdrawText";
